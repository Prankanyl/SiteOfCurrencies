#pragma checksum "/Users/Valera/Projects/SiteOfCurrencies/SiteOfCurrencies/Pages/ListCurrency.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "925473df26d92f1552557e480a216070c7c7c363"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"925473df26d92f1552557e480a216070c7c7c363", @"/Pages/ListCurrency.cshtml")]
        ...
        function currencies() {
            $.getJSON(uri + 'ExRates/Currencies').done(function (data)
            {
                  $.each(data, function (key, item) 
                  {
                      ...
                      $('<p>', { text: 'Наименование на английском языке: ' + item.Cur_Name_Eng }).append");
            WriteLiteral(@"To($('#res'));
                      ...
                      $('<p>',{ text: 'Количество единиц иностранной валюты: ' + item.Cur_");
            WriteLiteral(@"Scale  }).appendTo($('#res'));
        ...
        function currency() {
            $.getJSON(uri + 'ExRates/Currencies/' + $('#iCur').val())
                .done(function (data) {
                    ...
                    $('<p>', { text: 'Код используется для связи: ' + data.Cur_I");
            WriteLiteral(@"D }).appendTo($('#res'));
                    ...
                    $('<p>', { text: 'Наименование на английском языке, содержащее количество единиц: ' + data.Cur_QuotName_Eng }).appendTo($");
            WriteLiteral(@"('#res'));
                    ...
                    $('<p>', { text: 'Дата включения валюты в перечень валют: ' + data.Cur_DateEnd }).appendTo($('#res'));
                    $('<hr>', { text: '' }).appendTo($('#res'));
              ");
            WriteLiteral(@"      $('#btn').removeAttr(""disabled"");
                }).error(function (err) {
                    $('#btn').removeAttr(""disabled"");
                    alert('ошибка');
                });
            ...
            function rates(p) {
              ...
              .done(function (data) {
                  $.each(data, function (key, item) {
                      $('<p>', { te");
            WriteLiteral(@"xt: 'Внутренний код: ' + item.Cur_ID }).appendTo($('#res'));
                      $('<p>', { text: 'Код используется для связи: ' + item.Cur_ID }).appendTo($('#res'));
                      $('<p>', { text: 'Цифровой код: ' + item.Cur_Code }).appendTo($('#res'));
                      $('<p>', { text: 'Буквенный код: ' + item.Cur_Abbreviation }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке: ' + item.Cur_Name }).appendTo($('#res'));
                      ...
                      $('<p>', { text: 'Наименование валюты на русском языке, содержащее количество единиц: ' + item.Cur_QuotName }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на белорусском языке, содержащее количество единиц: ' + item.Cur_QuotName_Bel }).appen");
            WriteLiteral(@"dTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке, содержащее количество единиц: ' + item.Cur_QuotName_Eng }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке во множественном числе: ' + item.Cur_NameMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на белорусском языке во множественном числе: ' + item.Cur_Name_BelMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + item.Cur_Name_EngMulti }).appendTo($('#res'));
                      ...
                      $('<p>', { text: 'Дата включения валюты в перечень валют: ' + item.Cur_DateStart }).appendTo($('#res'));
                      $('<p>', ");
            WriteLiteral(@"{ text: 'Дата включения валюты в перечень валют: ' + item.Cur_DateEnd }).appendTo($('#res'));
                      $('<hr>', { text: '' }).appendTo($('#res')); 
                  });
                  $('#btn').removeAttr(""disabled"");
              }).error(function (err) {
           ...
           function ratestoday(p) {
              ...
              .done(function (data) {
                  $.each(data, function (key, item) {
                      ...
                      $('<p>', { text: 'Буквенный код: ' + item.Cur_Abbreviation }).appendTo($('#res'));
                      $(");
            WriteLiteral(@"'<p>', { text: 'Наименование валюты на русском языке: ' + item.Cur_Name }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на белорусском языке: ' + item.Cur_Name_Bel }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке: ' + item.Cur_Name_Eng }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке, содержащее количество единиц: ' + item.Cur_QuotName }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на белорусском языке, содержащее количество единиц: ' + item.Cur_QuotName_Bel }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке, содержащее количество единиц: ' + item.Cur_QuotName_Eng }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке во множественном числе: ' + item.Cur_NameMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на белорусском я");
            WriteLiteral(@"зыке во множественном числе: ' + item.Cur_Name_BelMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + item.Cur_Name_EngMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Количество единиц иностранной валюты: ' + item.Cur_Scale }).appendTo($('#res'));
                      $('<p>', { text: 'Периодичность установления курса: ' + item.Cur_Periodicity }).appendTo($('#res'));
                      $('<p>', { text: 'Дата включения валюты в перечень валют: ' + item.Cur_DateStart }).appendTo($('#res'));
            ...
            function rate(p) {
              ...
              .done(function (data) {
                  ...
                  $('<p>', { text: 'Наименование на белорусском языке: ' + data.Cur_Name_Bel }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование на английском языке: ' + data.Cur_Name_Eng }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование валюты на русском язы");
            WriteLiteral(@"ке, содержащее количество единиц: ' + data.Cur_QuotName }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование на белорусском языке, содержащее количество единиц: ' + data.Cur_QuotName_Bel }).appendTo($('#res'));
                  ...
                  $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + data.Cur_Name_EngMulti }).appendTo($('#res'));
                  $('<p>', { text: 'Количество единиц иностранной валюты: ' + data.Cur_Scale }).appendTo($('#res'));
                  $('<p>', { text: 'Периодичность установления курса: ' + data.Cur_Per");
            WriteLiteral(@"iodicity }).appendTo($('#res'));
                  $('<p>', { text: 'Дата включения валюты в перечень валют: ' + data.Cur_DateStart }).appendTo($('#res'));
                  $('<p>', { text: 'Дата включения валюты в перечень валют: ' + data.Cur_DateEnd }).appendTo($('#res'));
                  $('<hr>', { text: '' }).appendTo($('#res')); 
                  $('#btn').removeAttr(""disabled"");
            ...
            function ratetoday(p) {
             $.getJSON(uri + 'ExRates/Rates/' + $('#iCur').val(), { 'ParamMode': p })
              .done(function (data) {
                  ...
                  $('<p>', { text: 'Цифровой код: ' + data.Cur_Code }).appendTo($('#res'));
                  $('<");
            WriteLiteral(@"p>', { text: 'Буквенный код: ' + data.Cur_Abbreviation }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование валюты на русском языке: ' + data.Cur_Name }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование на белорусском языке: ' + data.Cur_Name_Bel }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование на английском языке: ' + data.Cur_Name_Eng }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование валюты на русском языке, содержащее количество единиц: ' + data.Cur_QuotName }).appendTo($('#res'));
                  ...
                  $('<p>', { text: 'Наименование валюты на русском языке во множественном числе: ' + data.Cur_NameMulti }).appendTo($('#res'));
 ");
            WriteLiteral(@"                 $('<p>', { text: 'Наименование валюты на белорусском языке во множественном числе: ' + data.Cur_Name_BelMulti }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + data.Cur_Name_EngMulti }).appendTo($('#res'));
                  $('<p>', { text: 'Количество единиц иностранной валюты: ' + data.Cur_Scale }).appendTo($('#res'));
                  $('<p>', { text: 'Периодичность установления курса: ' + data.Cur_Periodicity }).appendTo($('#res'));
                  $('<p>', { text: 'Дата включения валюты в перечень валют: ' + data.Cur_DateStart }).appendTo($('#res'));
            ...
            WriteLiteral(@"        });
              ...
              .done(function (data) {
                  $.each(data, function (key, item) {
                      ...
                      $('<p>', { text: 'Наименование на белорусском языке: ' + item.Cur_Name_Bel }).appendTo($('#res'));
                      $('<");
            WriteLiteral(@"p>', { text: 'Наименование на английском языке: ' + item.Cur_Name_Eng }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке, содержащее количество единиц: ' + item.Cur_QuotName }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на белорусском языке, содержащее количество единиц: ' + item.Cur_QuotName_Bel }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке, содержащее количество единиц: ' + item.Cur_QuotName_Eng }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке во множественном числе: ' + item.Cur_NameMulti }).appendTo($('#res'));
                      ...
                      $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + item.Cur_Name_EngMulti }).appendTo($('#res'));
               ");
            WriteLiteral(@"       $('<p>', { text: 'Количество единиц иностранной валюты: ' + item.Cur_Scale }).appendTo($('#res'));
                      $('<p>', { text: 'Периодичность установления курса: ' + item.Cur_Periodicity }).appendTo($('#res'));
                      $('<p>', { text: 'Дата включения валюты в перечень валют: ' + item.Cur_DateStart }).appendTo($('#res'));
                      $('<p>', { text: 'Дата включения валюты в перечень валют: ' + item.Cur_DateEnd }).appendTo($('#res'));
                      $('<hr>', { text: '' }).appendTo($('#res')); 
...
<div class=""container-fluid"" style=""background-color: #676dc5"">
    <h3 align=""center"" style=""color: #ffffff"">
        <b>API Национального банка для получения официального курса белорусского рубля по отношению к иностранным в");
            WriteLiteral("алютам.</b>\n    </h3>\n    <select id=\"mode\" style=\"text-align: center\">\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36331242", async() => {
            ...
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36332402", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36333561", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36334724", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36335923", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36337123", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36338289", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36339491", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36340694", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36341859", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36343047", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36344240", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "925473df26d92f1552557e480a216070c7c7c36345423", async() => {
    ...
    <input type=""button"" id=""btn"" value=""получить"" style=""text-align: center""/>
    <br />
</div>
