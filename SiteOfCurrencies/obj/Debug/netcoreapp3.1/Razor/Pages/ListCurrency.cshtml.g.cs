#pragma checksum "C:\Users\Паша\Desktop\SiteOfCurrencies\SiteOfCurrencies\Pages\ListCurrency.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c0e6d048bd654911d2f2931c8250e9cc10d88ce9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c0e6d048bd654911d2f2931c8250e9cc10d88ce9", @"/Pages/ListCurrency.cshtml")]
    ...
    <script type=""text/javascript"">
       ...
       ");
            ...
            $.getJSON(uri + 'ExRates/Currencies')
                .done(function (data) {
                    $.each(data, function (key, item) {
                       ");
            WriteLiteral(@" $('<li>', { text: JSON.stringify(item) }).appendTo($('#res'));
                    });
        ...
        function currencies() {
            $.getJSON(uri + 'ExRates/Currencies').done(function (data)
            {
                  $.each(data, function (key, item) 
                  {
                      ...
                      $('<p>',{ text: 'Наименование валюты на русском языке: ' + item.Cur_Name   }).appe");
        ...
        function currency() {
          ...
          ");
            WriteLiteral(@"  $.getJSON(uri + 'ExRates/Currencies/' + $('#iCur').val())
                .done(function (data) {
          ...
          ");
            WriteLiteral(@"          $('<p>', { text: 'Наименование на белорусском языке, содержащее количество единиц: ' + data.Cur_QuotName_Bel }).appendTo($('#res'));
                    ...
                    $('<p>', { text:");
            WriteLiteral(@" 'Дата включения валюты в перечень валют: ' + data.Cur_DateStart }).appendTo($('#res'));
            ...
            WriteLiteral(@"s(p) {
              ...
              .done(function (data) {
                  $.each(data, function (key, item) {
                      ...
                      $('<p>', { text: 'Наименование на английском языке: ' + item.Cur_Name_Eng }).appendTo($('#res'));
                     ");
            WriteLiteral(@" $('<p>', { text: 'Наименование валюты на русском языке, содержащее количество единиц: ' + item.Cur_QuotName }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на белорусском языке, содержащее количество единиц: ' + item.Cur_QuotName_Bel }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке, содержащее количество единиц: ' + item.Cur_QuotName_Eng }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке во множественном числе: ' + item.Cur_NameMulti }).appendTo($('#res'));
                      ...
                      $('<p>', { text: 'Количество единиц иностранной валюты: ' + item.Cur_Scale }).appendTo($('#res'));
  ");
            WriteLiteral(@"                    $('<p>', { text: 'Периодичность установления курса: ' + item.Cur_Periodicity }).appendTo($('#res'));
                      $('<p>', { text: 'Дата включения валюты в перечень валют: ' + item.Cur_DateStart }).appendTo($('#res'));
                      $('<p>', { text: 'Дата исключения валюты из перечня валют: ' + item.Cur_DateEnd }).appendTo($('#res'));
                      $('<hr>', { text: '' }).appendTo($('#res')); 
                  });
           ...
           function ratestoday(p) {
              ...
              .done(function (data) {
                  $.each(data, function (key, item) {
                      $('<p>', { text: 'Внутренний код: ' + item.Cur_ID }).appendTo($('#res'));
                      $('<p>', { tex");
            WriteLiteral(@"t: 'Код используется для связи: ' + item.Cur_ID }).appendTo($('#res'));
                      $('<p>', { text: 'Цифровой код: ' + item.Cur_Code }).appendTo($('#res'));
                      $('<p>', { text: 'Буквенный код: ' + item.Cur_Abbreviation }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке: ' + item.Cur_Name }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на белорусском языке: ' + item.Cur_Name_Bel }).appendTo($('#res'));
                      ...
                      $('<p>', { text: 'Наименование валюты на русском языке, содержащее количество единиц: ' + item.Cur_QuotName }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на белорусском языке, содержащее количество единиц: ' + item.Cur_QuotName_Bel }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке,");
            WriteLiteral(@" содержащее количество единиц: ' + item.Cur_QuotName_Eng }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке во множественном числе: ' + item.Cur_NameMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на белорусском языке во множественном числе: ' + item.Cur_Name_BelMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + item.Cur_Name_EngMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Количество единиц иностранной валюты: ' + item.Cur_Scale }).appendTo($('#res'));
                      $('<p>', { text: 'Периодичность установления курса: ' + item.Cur_Periodicity }).appendTo($('#res'));
                      $('<p>', { text: 'Дата включения валюты в перечень валют: ' + item.Cur_DateStart }).appendTo($('#res'));
                      $('<p>', { text: 'Дата исключения валюты из перечня валют: ' + item.Cur_DateEnd }).appendTo");
            WriteLiteral(@"($('#res'));
                      $('<hr>', { text: '' }).appendTo($('#res')); 
                  });
                  $('#btn').removeAttr(""disabled"");
            ...
            function rate(p) {
              ...
              .done(function (data) {
                  ...
                  $('<p>', { text: 'Цифровой код: ' + data.Cur_Code }).appendTo($('#res'));
                  $('<p>', { text: 'Буквенный код: ' + data.Cur_Abbreviation }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование валюты на русском языке: ' + data.Cur_Nam");
            WriteLiteral(@"e }).appendTo($('#res'));
                  ...
                  $('<p>', { text: 'Наименование валюты на белорусском языке во множественном числе: ' + data.Cur_Name_BelMulti }).appendTo($('#res'));
          ");
            WriteLiteral(@"        $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + data.Cur_Name_EngMulti }).appendTo($('#res'));
                  $('<p>', { text: 'Количество единиц иностранной валюты: ' + data.Cur_Scale }).appendTo($('#res'));
                  $('<p>', { text: 'Периодичность установления курса: ' + data.Cur_Periodicity }).appendTo($('#res'));
            ...
            WriteLiteral(@" })
              .done(function (data) {
                  ...
                  $('<p>', { text: 'Наименование на английском языке: ' + data.Cur_Name_Eng }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование валюты на русском языке, содержащее количество единиц: ' + data.Cur_QuotName }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование на белорусском языке, содержащее ко");
            WriteLiteral(@"личество единиц: ' + data.Cur_QuotName_Bel }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование на английском языке, содержащее количество единиц: ' + data.Cur_QuotName_Eng }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование валюты на русском языке во множественном числе: ' + data.Cur_NameMulti }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование валюты на белорусском языке во множественном числе: ' + data.Cur_Name_BelMulti }).appendTo($('#res'));
                  $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + data.Cur_Name_EngMulti }).appendTo($('#res'));
                  ...
                  $('<p>', { text: 'Дата включения валюты в перечень валют: ' + data.Cur_DateStart }).appendTo($('#res'));
");
            WriteLiteral(@"                  $('<p>', { text: 'Дата исключения валюты из перечня валют: ' + data.Cur_DateEnd }).appendTo($('#res'));
                  $('<hr>', { text: '' }).appendTo($('#res')); 
                  $('#btn').removeAttr(""disabled"");
              }).error(function (err) {
                  $('#btn').removeAttr(""disabled"");
              ...
              .done(function (data) {
                  $.each(data, function (key, item) {
                      $('<p>', { text: 'Внутренний код: ' + item.Cur_ID }).appendTo($('#res'));
                      $('<p>', { text: 'Код используется для связи: ' + item.Cur_ID }).appendTo($('#res'));
                      $('<p>', { text: 'Цифровой код: ' + item.Cur_Code }).appendTo");
            WriteLiteral(@"($('#res'));
                      $('<p>', { text: 'Буквенный код: ' + item.Cur_Abbreviation }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на русском языке: ' + item.Cur_Name }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на белорусском языке: ' + item.Cur_Name_Bel }).appendTo($('#res'));
            ...
            WriteLiteral(@"ке во множественном числе: ' + item.Cur_NameMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование валюты на белорусском языке во множественном числе: ' + item.Cur_Name_BelMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Наименование на английском языке во множественном числе: ' + item.Cur_Name_EngMulti }).appendTo($('#res'));
                      $('<p>', { text: 'Количество единиц иностранной валюты: ' + item.Cur_Scale }).appendTo($('#res'));
                      $('<p>', { text: 'Периодичность установления курса: ' + item.Cur_Periodicity }).appendTo($('#res'));
    ...
    <div class=""container-fluid"" style=""background-color: #676dc5;"">
        ...
        <select id=""mode"" style=""text-align: center; "">
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce931771", async() => {
            ...
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce932953", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce934134", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce935319", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce936540", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce937762", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce938950", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce940174", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce941399", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce942586", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce943796", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce945011", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c0e6d048bd654911d2f2931c8250e9cc10d88ce946216", async() => {
